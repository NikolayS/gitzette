...
SAMOREV_NOT_BEFORE=invalid assert_exit 5 '[{"context":"samorev","state":"success","created_at":"2026-08-16T00:01:00Z","creator":{"id":280144521,"login":"samo-agent"}}]'
SAMOREV_NOT_BEFORE=2026-08-16T00:02:00Z assert_exit 3 '[{"context":"samorev","state":"success","created_at":"invalid","creator":{"id":280144521,"login":"samo-agent"}}]'
