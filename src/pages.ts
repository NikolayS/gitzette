...
async function fetchAndServeDispatch(
  ...
  const IMG_FIX_STYLE = `${ogTags}\n${headTags()}<link rel="preconnect" href="https://fonts.googleapis.com"><link href="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;600;700&family=Playfair+Display:ital,wght@0,700;0,900;1,700;1,900&display=swap" rel="stylesheet"><style>body img{max-width:100%!important;height:auto!important;}table{max-width:100%!important;width:100%!important;}td,th{word-break:break-word;}/* normalize old broadsheet left/right layout (#24) */.broadsheet-left{display:none!important;}.broadsheet-right{width:100%!important;max-width:960px!important;margin:0 auto!important;}/* cap illustration height to 40vh so square images dont dominate the column */.article-image{max-height:40vh!important;}.article-image img{max-height:40vh!important;width:100%!important;height:auto!important;display:block!important;filter:drop-shadow(2px 3px 5px rgba(0,0,0,0.15))!important;background:none!important;}/* override legacy --link blue (#50) */body{--link:var(--ink,#0f0f0f)!important;}</style>`;
